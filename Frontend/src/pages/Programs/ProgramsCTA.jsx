...
const ProgramsCTA = () => {
  return (
    <section className="relative overflow-hidden bg-[#e6fffb]">
      <div className="pointer-events-none absolute -left-32 top-0 h-72 w-72 rounded-full bg-cyan-200/50 blur-3xl" />

      <div className="pointer-events-none absolute -right-32 bottom-0 h-80 w-80 rounded-full bg-teal-200/50 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
            ...
            join AIRS to develop practical skills and build your professional
            future.
          </p>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              ...
              className="group inline-flex min-w-[160px] items-center justify-center gap-2 rounded-full border border-[#0d9488]/30 bg-white/50 px-7 py-3.5 text-sm font-semibold text-[#0d9488] transition-all duration-300 hover:-translate-y-1 hover:border-[#0d9488] hover:bg-[#0d9488] hover:text-white"
            >
              <FiPhone size={17} />
              Call Us
            </a>
