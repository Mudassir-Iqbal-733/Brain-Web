        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
          <div className="group rounded-3xl border border-slate-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#0d9488]/30 hover:bg-cyan-50/50 hover:shadow-xl hover:shadow-[#0d9488]/10 sm:p-9">
            ...
            <p className="mt-6 text-base leading-7 text-slate-600">
              ...
              rehabilitation sciences, develop skilled professionals for the
              healthcare sector, and promote research and innovation.
            </p>
            ...
            <div className="mt-6 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm leading-6 text-slate-600">
                  Provide high-quality education in rehabilitation sciences
                </span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm leading-6 text-slate-600">
                  Develop skilled professionals for the healthcare sector
                </span>
              </div>
          ...
          <div className="group rounded-3xl border border-slate-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#0d9488]/30 hover:bg-cyan-50/50 hover:shadow-xl hover:shadow-[#0d9488]/10 sm:p-9">
            ...
            <p className="mt-6 text-base leading-7 text-slate-600">
              To be a globally recognized leader in rehabilitation sciences
              education, setting benchmarks in quality, innovation, and
              research. We envision a future where our graduates are at the
              forefront of healthcare delivery, contributing to the well-being
